...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Using probabilistic LDA to extract and analyse topics in transcript data.',
    stack: ['Python'],
  ...
  },
  {
    ...
    description: 'A collection of time series models used to analyse and model different problems.',
    stack: ['R'],
